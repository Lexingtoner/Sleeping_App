...
- Дополнительные **Activity**: Breathing, Meditation, Sleep Tips, Profile (открываются с Home через quick actions).
- Улучшенный UX: единый `ScreenHeader`, корректные подписи/иконки нижней навигации и быстрые переходы без дублирования экранов.
- На экране `Sound Library` добавлен рабочий поиск по недавно проигрываемым трекам.
